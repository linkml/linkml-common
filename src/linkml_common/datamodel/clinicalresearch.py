...
class ClinicalCohort(PhysicalEntity):
    ...
    id: str = Field(..., description="""A unique identifier for a thing""")
    name: Optional[str] = Field(None, description="""A human-readable name for a thing""")
    type: Literal["ClinicalCohort"] = Field("ClinicalCohort", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
class ClinicalCohortDefinition(InformationEntity):
    ...
    id: str = Field(..., description="""A unique identifier for a thing""")
    name: Optional[str] = Field(None, description="""A human-readable name for a thing""")
    type: Literal["ClinicalCohortDefinition"] = Field("ClinicalCohortDefinition", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
class ClinicalCohortEnrollment(Event):
    ...
    """
    patient: Optional[Patient] = Field(None)
    cohort: Optional[str] = Field(None)
    starts_at: Optional[TimePoint] = Field(None)
    ends_at: Optional[TimePoint] = Field(None)
    happens_at: Optional[TimePoint] = Field(None)
    has_interval: Optional[TemporalInterval] = Field(None)
...
ClinicalCohort.update_forward_refs()
ClinicalCohortDefinition.update_forward_refs()
ClinicalCohortEnrollment.update_forward_refs()
