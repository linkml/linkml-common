...
class Relationship(Intangible):
    subject: Optional[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,PhysicalSystem,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,DataStructure,Location,PointLocation,Specification,Procedure]] = Field(None)
    predicate: Optional[str] = Field(None)
    object: Optional[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,PhysicalSystem,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,DataStructure,Location,PointLocation,Specification,Procedure]] = Field(None)
...
class PhysicalSystem(PhysicalEntity):
    ...
    events: Optional[List[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,PhysicalSystem,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,DataStructure,Location,PointLocation,Specification,Procedure]]] = Field(default_factory=list)
    classification: Optional[str] = Field(None, description="""A precise classification of the thing, using a concept from an ontology, controlled vocabulary, thesaurus, or taxonomy. Some schema classes may choose to restrict the range of values which this slot can take, using `values_from`, or bindings.""")
    ontology_types: Optional[List[str]] = Field(default_factory=list, description="""A collection of concepts that help to classify the thing, using concepts from an ontolology,  thesaurus, or taxonomy.""")
    description: Optional[str] = Field(None, description="""A human-readable description for a thing""")
    id: str = Field(..., description="""A unique identifier for a thing""")
...
class EntitySet(Intangible):
    ...
    """
    members: Optional[List[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,PhysicalSystem,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,DataStructure,Location,PointLocation,Specification,Procedure]]] = Field(default_factory=list, description="""The members of the collection""")
