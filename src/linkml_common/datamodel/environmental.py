...
class PhysicalSystem(PhysicalEntity):
    ...
    events: Optional[List[Union[Entity,Intangible,PhysicalEntity,Event,SubjectHistory,SubjectObservationHistory,Observation,ExecutionOfProcedure,Investigation,PlannedProcess,ComputationalPlannedProcess,MaterialCollection,MaterialProcessing,InvestigativeProcess,SampleCollectionProcess,DataGenerationFromSample,SampleProcessing,Measurement,QualitativeObservation,PhysicalDevice,PhysicalSystem,Place,SampleMaterial,Landform,AstronomicalBody,EnvironmentalSite,EnvironmentalSystem,Climate,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,Quantity,QuantityRange,SetOfObservations,Variable,TimePointOrTemporalInterval,PlannedProcessConfiguration,ComputationalModel,Simulation,DigitalTwin,ClimateModel,TemporalInterval,TimePoint,SimpleQuantity,Ratio,Duration,TemporalRelationship,Location,PostalAddress,PointLocation,GeoBoxLocation,GeoPointLocation,Specification,StudyHypothesis,StudyResult,Procedure,InvestigativeProtocol,StudyDesign,QuantityKind,UnitConcept]]] = Field(default_factory=list)
    classification: Optional[str] = Field(None, description="""A precise classification of the thing, using a concept from an ontology, controlled vocabulary, thesaurus, or taxonomy. Some schema classes may choose to restrict the range of values which this slot can take, using `values_from`, or bindings.""")
    ontology_types: Optional[List[str]] = Field(default_factory=list, description="""A collection of concepts that help to classify the thing, using concepts from an ontolology,  thesaurus, or taxonomy.""")
    description: Optional[str] = Field(None, description="""A human-readable description for a thing""")
    id: str = Field(..., description="""A unique identifier for a thing""")
...
class ComputationalModel(Model, Intangible):
    models: Optional[Union[Entity,Intangible,PhysicalEntity,Event,SubjectHistory,SubjectObservationHistory,Observation,ExecutionOfProcedure,Investigation,PlannedProcess,ComputationalPlannedProcess,MaterialCollection,MaterialProcessing,InvestigativeProcess,SampleCollectionProcess,DataGenerationFromSample,SampleProcessing,Measurement,QualitativeObservation,PhysicalDevice,PhysicalSystem,Place,SampleMaterial,Landform,AstronomicalBody,EnvironmentalSite,EnvironmentalSystem,Climate,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,Quantity,QuantityRange,SetOfObservations,Variable,TimePointOrTemporalInterval,PlannedProcessConfiguration,ComputationalModel,Simulation,DigitalTwin,ClimateModel,TemporalInterval,TimePoint,SimpleQuantity,Ratio,Duration,TemporalRelationship,Location,PostalAddress,PointLocation,GeoBoxLocation,GeoPointLocation,Specification,StudyHypothesis,StudyResult,Procedure,InvestigativeProtocol,StudyDesign,QuantityKind,UnitConcept]] = Field(None)
    type: Literal["ComputationalModel"] = Field("ComputationalModel", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")


class Simulation(ComputationalModel):
    models: Optional[Union[Entity,Intangible,PhysicalEntity,Event,SubjectHistory,SubjectObservationHistory,Observation,ExecutionOfProcedure,Investigation,PlannedProcess,ComputationalPlannedProcess,MaterialCollection,MaterialProcessing,InvestigativeProcess,SampleCollectionProcess,DataGenerationFromSample,SampleProcessing,Measurement,QualitativeObservation,PhysicalDevice,PhysicalSystem,Place,SampleMaterial,Landform,AstronomicalBody,EnvironmentalSite,EnvironmentalSystem,Climate,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,Quantity,QuantityRange,SetOfObservations,Variable,TimePointOrTemporalInterval,PlannedProcessConfiguration,ComputationalModel,Simulation,DigitalTwin,ClimateModel,TemporalInterval,TimePoint,SimpleQuantity,Ratio,Duration,TemporalRelationship,Location,PostalAddress,PointLocation,GeoBoxLocation,GeoPointLocation,Specification,StudyHypothesis,StudyResult,Procedure,InvestigativeProtocol,StudyDesign,QuantityKind,UnitConcept]] = Field(None)
    type: Literal["Simulation"] = Field("Simulation", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")


class DigitalTwin(ComputationalModel):
    models: Optional[Union[Entity,Intangible,PhysicalEntity,Event,SubjectHistory,SubjectObservationHistory,Observation,ExecutionOfProcedure,Investigation,PlannedProcess,ComputationalPlannedProcess,MaterialCollection,MaterialProcessing,InvestigativeProcess,SampleCollectionProcess,DataGenerationFromSample,SampleProcessing,Measurement,QualitativeObservation,PhysicalDevice,PhysicalSystem,Place,SampleMaterial,Landform,AstronomicalBody,EnvironmentalSite,EnvironmentalSystem,Climate,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,Quantity,QuantityRange,SetOfObservations,Variable,TimePointOrTemporalInterval,PlannedProcessConfiguration,ComputationalModel,Simulation,DigitalTwin,ClimateModel,TemporalInterval,TimePoint,SimpleQuantity,Ratio,Duration,TemporalRelationship,Location,PostalAddress,PointLocation,GeoBoxLocation,GeoPointLocation,Specification,StudyHypothesis,StudyResult,Procedure,InvestigativeProtocol,StudyDesign,QuantityKind,UnitConcept]] = Field(None)
    type: Literal["DigitalTwin"] = Field("DigitalTwin", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
class EnvironmentalSite(Place):
    ...
    id: str = Field(..., description="""A unique identifier for a thing""")
    name: Optional[str] = Field(None, description="""A human-readable name for a thing""")
    type: Literal["EnvironmentalSite"] = Field("EnvironmentalSite", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
class EnvironmentalSystem(PhysicalSystem):
    ...
    id: str = Field(..., description="""A unique identifier for a thing""")
    name: Optional[str] = Field(None, description="""A human-readable name for a thing""")
    type: Literal["EnvironmentalSystem"] = Field("EnvironmentalSystem", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
class Climate(EnvironmentalSystem):
    ...
    id: str = Field(..., description="""A unique identifier for a thing""")
    name: Optional[str] = Field(None, description="""A human-readable name for a thing""")
    type: Literal["Climate"] = Field("Climate", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")


class ClimateModel(Simulation):
    models: Optional[str] = Field(None)
    type: Literal["ClimateModel"] = Field("ClimateModel", description="""A type for a thing. The range of this should be a class within the schema. It is intended for schema-based classification. Anything beneath the shoreline of the schema should use `classification`.""")
...
ComputationalModel.update_forward_refs()
Simulation.update_forward_refs()
DigitalTwin.update_forward_refs()
EnvironmentalSite.update_forward_refs()
EnvironmentalSystem.update_forward_refs()
Climate.update_forward_refs()
ClimateModel.update_forward_refs()
