...
class NamedThing(Identified, Entity):
...
class Ratio(Quantity):
    ...
    """
    numerator: Optional[Union[Quantity,SimpleQuantity,Ratio]] = Field(None, description="""The numerator of the ratio""")
    denominator: Optional[Union[Quantity,SimpleQuantity,Ratio]] = Field(None, description="""The denominator of the ratio""")
    has_quantity_kind: Optional[str] = Field(None, description="""The kind of quantity""")
...
class QuantityRange(Intangible):
    ...
    """
    lower_bound: Optional[Union[Quantity,SimpleQuantity,Ratio]] = Field(None, description="""The lower bound of the range""")
    upper_bound: Optional[Union[Quantity,SimpleQuantity,Ratio]] = Field(None, description="""The upper bound of the range""")
...
class UnitConversionOperation(MathematicalOperation):
    ...
    """
    inputs: Optional[List[Union[Quantity,SimpleQuantity,Ratio]]] = Field(default_factory=list, description="""The input unit""")
    outputs: Optional[List[Union[Quantity,SimpleQuantity,Ratio]]] = Field(default_factory=list, description="""The output unit""")
    parts: Optional[List[MathematicalOperation]] = Field(default_factory=list, description="""The parts of the process""")
    immediate_preceding_steps: Optional[List[MathematicalOperation]] = Field(default_factory=list, description="""The steps that immediately precede this step""")
